...
def get_estimated_price(price, location, Carpet_Area, Floor, Transaction, Furnishing, facing, overlooking, Bathroom,
                        Balcony, Ownership):
...
if __name__ == '__main__':
    ...
    print(get_estimated_price(6000, 'thane', 1283.153494, '10 out of 11', 'Resale', 'Unfurnished', 'Unknown', 'Unknown',
                              1.0, 2.0, 'Unknown'))